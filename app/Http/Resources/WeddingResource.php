...
class WeddingResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'creators' => $this->when($this->relationLoaded('creators'), [
                ...
                'other' => $creators->has('other') ? new WeddingCreatorResource($creators->get('other')) : null,
            ]),
            'days' => WeddingDayResource::collection($this->whenLoaded('days')),
